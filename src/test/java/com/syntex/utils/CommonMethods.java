...
public class CommonMethods extends BaseClass{
    ...
    public static void checkBox(List<WebElement> list2, String s) {
    
    	System.out.println(list2.size());
    	for(WebElement click:list2) {
    		if(click.isEnabled()) {
    		String value=click.getText();
    ...
    public static void radioDemo(List<WebElement> list, String valueToSelect) {
    	
		List<WebElement> professionList = list;
		...
		for (WebElement profession : professionList) {
			...
			if (profession.isEnabled()) {
				...
				String value = profession.getText();
				System.out.println(value);
		 ...
		 public static void selDate(List<WebElement>cells,String expectedDate ) {
		 ...
		 public static void selectList(WebElement elem, String text) {
			 List<WebElement> listLocations = elem.findElements(By.tagName("li"));
